...
Уеб приложение за четене на **NHK Easy News** с помощни инструменти за изучаване на японски (в процес на разработка).
...
Текущата версия:
- поддържа превод на български и английски за заглавия, абзаци и думи
- отваря popup при клик върху елемент от текста
- показва за глаголите: превод, речникова форма, образуване, формула
