...
<div class=\"author-info\" data-bg=\"Текущата версия:<br>* поддържа превод на български и английски за заглавия, абзаци и думи<br>* отваря popup при клик върху елемент от текста<br>* показва за глаголите: превод, речникова форма, образуване, формула<br>* подчертава граматични конструкции с синьо<br>* подчертава глаголи с оранжево<br>* дава канджи мнемоника (топ 500 канджи)<br>* аудио с тракинг в текста<br>* генерира Anki файлове за основните елементи от текста<br>* стрницата поддържа добавяне на уеб-апликация за мобилни устройства (както и за Мак компютри)<br>* Новините идват от NHK Easy News. Проектът не е официален продукт на NHK.<br><br><span class='author-blue'>Създадено от Веселин Баев<br>GitHub: vebaev<br>Email: vebaev@gmail.com</span>\" data-en=\"Current version:<br>* supports Bulgarian and English translation for titles, paragraphs, and words<br>* opens a popup when clicking a text element<br>* shows for verbs: translation, dictionary form, formation, formula<br>* highlights grammar structures in blue<br>* highlights verbs in orange<br>* provides kanji mnemonics (top 500 kanji)<br>* audio with text tracking<br>* generates Anki files for the main elements in the text<br>* the page supports adding as a web app on mobile devices (and on Mac computers)<br>* News comes from NHK Easy News. This project is not an official NHK product.<br><br><span class='author-blue'>Created by Veselin Baev<br>GitHub: vebaev<br>Email: vebaev@gmail.com</span>\"></div>
